...
public class ManageMain extends JFrame implements ActionListener {
    /*
     * Declaration of labels, textfields, comboboxes, buttons, menu, panel,
     * menuitems, list, ArrayList
     */
    // labels used to display text on gui
    public JLabel lblpun, lblpnme, lblpedate, lblptime, lblphigh, lblplvl, lblpshare, lblwnme, lblwrank, lblnofp,
            lblnofw, lblnofhsp, lblnofhrw, lblstatus, lblwun, lblhead, lblfoot, lbllogname, lbllogpass, lblnull;
    ...
    public JButton btnpadd, btnpdel, btnprls, btnpdsp, btnpdspall, btnwadd, btnwdel, btnwdspall, btnwclr, btnpclr,
            btnlogin;
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == menuprisoner) {
            ...
            if (e.getSource() == menucheck) {
                ...
                try {
                    ...
                    Connection connect = DriverManager
                            .getConnection("jdbc:MySql://localhost:" + portNum + "/shubhams_prison", "root", "root");
                ...
                lblstatus.setText("The prison must have " + count[0] / 5 + " low rank warden and " + count[1] * 2 / 4
                        + " high rank warden.");
                ...
                try {
                    ...
                    String sql = "insert into prisoner values ('" + txtpun.getText() + "','" + txtpnme.getText() + "','"
                            + txtpedate.getText() + "','" + txtptime.getText() + "','" + cmbphigh.getSelectedItem()
                            + "','"
                            + txtplvl.getText() + "','" + cmbpshare.getSelectedItem() + "','" + "inprison" + "')";
                    // validates if any field left empty
                    if (txtpun.getText().equals("") || txtpnme.getText().equals("") || txtpedate.getText().equals("")
                            || txtptime.getText().equals("") || txtplvl.getText().equals("")) {
                ...
                try {
                    ...
                    if (rs.next()) {
                        ...
                        calcurrent.set(calendar.get(Calendar.YEAR), calendar.get(Calendar.MONTH),
                        ...
                        long servedays = (calcurrent.getTimeInMillis() - calentry.getTimeInMillis())
                                / (1000 * 60 * 60 * 24);
                        ...
                        if ((long) rs.getInt(4) - servedays < 7) {
                            ...
                            JOptionPane.showMessageDialog(null, "Must have less than 7 days left in prisonment",
                                    "Alert",
                ...
                try {
                    ...
                    if (rs.next()) {
                        ...
                        JOptionPane.showMessageDialog(null, "This Prisoner is no longer available", "Alert",
                                JOptionPane.INFORMATION_MESSAGE);
                        clear();
                    }
                    rs.close();
                ...
                try {
                    ...
                    while (rs.next()) {
                        lstp.add("Unique No. = " + rs.getString(1) + ", Name = " + rs.getString(2) + ", Date of entry =  "
                                + rs.getString(3) + ", Time to serve = " + rs.getString(4) + ", Security = "
                                + rs.getString(5)
                                + ", Security Level = " + rs.getString(6) + ", Can Share Cell = " + rs.getString(7));
                    }
                    rs.close();
                    state.close();
                    clear();
                ...
                try {
                    ...
                    String sql = "insert into warden (wun, wname, wrank, status) values ('" + txtwun.getText() + "','"
                            + txtwnme.getText() + "','" + txtwrank.getText() + "','" + "working" + "')";
            ...
            // checking to see if click event's source matches or not with this button
            // source
            ...
            // source
                ...
                try {
                    ...
                    while (rs.next()) {
                        lstw.add("Unique No. = " + rs.getInt(1) + ", Name = " + rs.getString(2) + ", Rank = "
                                + rs.getInt(3));
                    }
                    rs.close();
                    state.close();
            ...
            // source
                ...
                try {
                    ...
                    if (txtlogname.getText().equals("shubham") && txtlogpass.getText().equals("jaihind")) {
                        ...
                        // greets user
                        JOptionPane.showMessageDialog(null, "Welcome Shubham", "Information",
                                JOptionPane.INFORMATION_MESSAGE);
                    } else {
                        // warns user for wrong authentication
                        JOptionPane.showMessageDialog(null, "Wrong User Name or Password", "Warning",
